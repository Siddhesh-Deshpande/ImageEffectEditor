...
@Component({
  selector: 'app-sepia',
  templateUrl: './sepia.component.html',
  styleUrls: ['./sepia.component.scss']
})
export class SepiaComponent implements OnInit {
  ...
  applyEffect(): void {
    if (this.selectedFile) {
      this.photoEffectService.applySepiaEffect(this.selectedFile)
